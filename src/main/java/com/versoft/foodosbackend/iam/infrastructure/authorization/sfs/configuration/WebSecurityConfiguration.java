package com.versoft.foodosbackend.iam.infrastructure.authorization.sfs.configuration;


import com.versoft.foodosbackend.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.versoft.foodosbackend.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.versoft.foodosbackend.iam.infrastructure.tokens.jwt.BearerTokenService;
...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(configurer -> configurer.configurationSource(p -> {
