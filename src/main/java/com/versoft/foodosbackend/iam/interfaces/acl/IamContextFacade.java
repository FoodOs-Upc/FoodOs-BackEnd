package com.versoft.foodosbackend.iam.interfaces.acl;
...
import com.versoft.foodosbackend.iam.domain.model.queries.GetUserByIdQuery;
import com.versoft.foodosbackend.iam.domain.model.queries.GetUserByUsernameQuery;
import com.versoft.foodosbackend.iam.domain.services.UserCommandService;
import com.versoft.foodosbackend.iam.domain.services.UserQueryService;
...
public class IamContextFacade {
     ...
     */
    /*
    public Long createUser(String username, String password,Long profileId) {
    ...
    public Long createUser(String username, String password, String roleName) {
        var roles = roleName != null ? Role.toRoleFromName(roleName) : new Role();
